...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/anabulbet)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/anabulbet
```

A live public deployment of this template is available at [https://anabulbet.templates.workers.dev](https://anabulbet.templates.workers.dev)
